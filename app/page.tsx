      ...
      <header className="relative z-10 border-b border-border/50 backdrop-blur-sm">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold font-orbitron">Caesar-Cipher 2025</span>
          </div>
      ...
      <section className="relative py-20 px-4 text-center">
        <div className="container mx-auto max-w-4xl">
          ...
          <h1 className="text-5xl md:text-7xl font-bold font-orbitron mb-6 neon-glow text-primary">
            Caesar-<span className="text-secondary">Cipher</span>
          </h1>

          <div className="text-2xl md:text-3xl mb-8 terminal-cursor">
            <span className="text-muted-foreground">{">"} </span>
            <span>The Ultimate Hackathon </span>
          </div>

          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            Join the most electrifying hackathon competition at our college. Code your way to victory.
          </p>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="p-6 bg-card border-border/50 hover:border-primary/50 transition-colors">
              ...
              <p className="text-muted-foreground">8 Hours of Non-stop Coding</p>
            ...
            <Card className="p-6 bg-card border-border/50 hover:border-primary/50 transition-colors">
              ...
              <p className="text-muted-foreground">Kathir college of Engineering</p>
              <p className="text-sm text-secondary mt-2"> Floor 3 , CCE</p>
            </Card>
        ...
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="p-8 bg-gradient-to-b from-secondary/20 to-transparent border-secondary/50">
              ...
              <p className="text-muted-foreground">+ Project Intake</p>
            </Card>
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <Card className="p-8 bg-card border-border/50">
            <div className="text-center mb-8">
              ...
              <h3 className="text-2xl font-bold mb-2">powered by Rotract Club</h3>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="text-center p-4 border border-border/50 rounded-lg hover:border-primary/50 transition-colors">
                <h4 className="text-lg font-bold text-primary mb-2">Rtr . NAGARAJ</h4>
                <p className="text-muted-foreground">Vice President</p>
                <p className="text-sm text-secondary mt-2">Rotractor of kathir college of Engineering</p>
              </div>

              <div className="text-center p-4 border border-border/50 rounded-lg hover:border-secondary/50 transition-colors">
                <h4 className="text-lg font-bold text-secondary mb-2">Rtr . SHYAM I</h4>
                <p className="text-muted-foreground">Rotractor</p>
                <p className="text-sm text-primary mt-2">Rotractor of kathir college of Engineering</p>
              </div>
              <div className="text-center p-4 border border-border/50 rounded-lg hover:border-secondary/50 transition-colors">
                <h4 className="text-lg font-bold text-primary mb-2">Rtr . GOBI I</h4>
                <p className="text-muted-foreground">Rotractor</p>
                <p className="text-sm text-secondary mt-2">Rotractor of kathir college of Engineering</p>
              </div>
            </div>
      ...
      <footer className="border-t border-border/50 py-8 px-4">
        <div className="container mx-auto max-w-4xl text-center">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <span className="font-bold font-orbitron">caesar-cipher 2025</span>
          </div>
          <p className="text-muted-foreground mb-4">Organized by Rotaract Club • Powered by CometInfinity</p>
